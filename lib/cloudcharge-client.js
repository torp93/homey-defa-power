...
class CloudChargeClient {
  ...
  // Laderen ligger under receivingAccess her. /chargers/private returnerer tom
  // liste for en privat DEFA Power-eier, så den er ikke brukbar til paring.
  getMyChargers() {
    return this._call('GET', '/mychargers');
  }

  // Brukes kun som reserve når /mychargers er tom. En bruker har en lader som
  // vises i CloudCharge-appen, men som ikke dukker opp i /mychargers i det hele
  // tatt — begge listene der kom tomme tilbake.
  getPrivateChargers() {
